...
void HeapBinomial::faSubarboreStang(Nod *viitorSubarbore, Nod *tata) {
...
void HeapBinomial::consolideaza() {
    if (m_pStart == nullptr) {
...
void HeapBinomial::insereaza(int val) {
...
HeapBinomial *HeapBinomial::reuneste(HeapBinomial *a, HeapBinomial *b) {
...
void HeapBinomial::extrageMaxim() {
...
Nod *HeapBinomial::getMaxim() const {
    // Setup initial
